...
### This is done for the seasonal datasets that is going to be used for the first part of modeling
...
### This is done for the weekly datasets that are going to be used for the second part of modeling

```{r, part 2}
s_com_week <- rbind(s17_2, s18_2, s19_2)
s_com_week <- s_com_week %>% 
  select(-player_name:-position)
lasso.w <- l1ce(total_points ~ ict_index, data = s_com_week)
summary(lasso.w)$coefficients
